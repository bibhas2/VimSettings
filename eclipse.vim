...
" Syntax group
highlight Comment    gui=none guifg=#3F7F5F guibg=bg      ctermfg=2
...
highlight PreProc    gui=none guifg=#7f0055 guibg=bg      ctermfg=Green
highlight Special    gui=none guifg=#7F0055 guibg=bg      ctermfg=DarkMagenta
highlight Statement  gui=none guifg=#7F0055 guibg=bg      ctermfg=White
...
highlight String     gui=none guifg=#0000ff guibg=bg      ctermfg=Yellow
